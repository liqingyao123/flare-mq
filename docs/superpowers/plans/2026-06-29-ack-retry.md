...
**Files:**
- Modify: `ruyuan-mq-store/src/main/java/com/ruyuan/mq/store/Message.java`
...
Run: `mvn compile -pl ruyuan-mq-store -am`
Expected: BUILD SUCCESS

- [ ] **Step 4: Commit**

```bash
git add ruyuan-mq-store/src/main/java/com/ruyuan/mq/store/Message.java
...
**Files:**
- Modify: `ruyuan-mq-store/src/main/java/com/ruyuan/mq/store/MessageSerializer.java`
...
```bash
git add ruyuan-mq-store/src/main/java/com/ruyuan/mq/store/MessageSerializer.java
...
Run: `mvn compile -pl ruyuan-mq-broker -am`
Expected: BUILD SUCCESS
...
- Produces: `com.ruyuan.mq.client.producer.Message.messageId` populated after pull
...
**Files:**
- Modify: `ruyuan-mq-broker/src/main/java/com/ruyuan/mq/broker/ack/AckRecord.java`
- Modify: `ruyuan-mq-broker/src/main/java/com/ruyuan/mq/broker/ack/AckManager.java`
...
```bash
git add ruyuan-mq-broker/src/main/java/com/ruyuan/mq/broker/ack/AckRecord.java \
        ruyuan-mq-broker/src/main/java/com/ruyuan/mq/broker/ack/AckManager.java
...
```bash
git add ruyuan-mq-broker/src/main/java/com/ruyuan/mq/broker/ack/AckManager.java
...
import com.ruyuan.mq.broker.ack.RetryMessageHandler;
```
