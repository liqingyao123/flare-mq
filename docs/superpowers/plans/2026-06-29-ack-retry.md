...
**Files:**
- Modify: `flare-mq-store/src/main/java/com/ruyuan/mq/store/Message.java`
...
```bash
git add flare-mq-store/src/main/java/com/ruyuan/mq/store/Message.java
...
**Files:**
- Modify: `flare-mq-store/src/main/java/com/ruyuan/mq/store/MessageSerializer.java`
...
```bash
git add flare-mq-store/src/main/java/com/ruyuan/mq/store/MessageSerializer.java
...
**Files:**
- Modify: `flare-mq-broker/src/main/java/com/ruyuan/mq/broker/ack/AckRecord.java`
- Modify: `flare-mq-broker/src/main/java/com/ruyuan/mq/broker/ack/AckManager.java`
...
```bash
git add flare-mq-broker/src/main/java/com/ruyuan/mq/broker/ack/AckRecord.java \
        flare-mq-broker/src/main/java/com/ruyuan/mq/broker/ack/AckManager.java
...
```bash
git add flare-mq-broker/src/main/java/com/ruyuan/mq/broker/ack/AckManager.java
