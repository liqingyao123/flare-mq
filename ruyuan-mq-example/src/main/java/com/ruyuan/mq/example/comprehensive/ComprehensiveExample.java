package com.ruyuan.mq.example.comprehensive;
 ...
 *
 * Demonstrates the complete usage flow of RuYuan MQ, including:
...
public class ComprehensiveExample {
    ...
    public static void main(String[] args) {
        logger.info("=== RuYuan MQ Comprehensive Example Started ===");
        ...
        try {
            ...
            logger.info("=== RuYuan MQ Comprehensive Example Completed ===");
