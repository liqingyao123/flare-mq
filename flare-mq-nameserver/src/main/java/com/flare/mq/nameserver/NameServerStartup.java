...
public class NameServerStartup {
    ...
    public static void main(String[] args) {
        try {
            logger.info("=== FlareMQ NameServer is starting ===");
            ...
            logger.info("=== FlareMQ NameServer started successfully ===");
    ...
    private static void printUsage() {
        System.out.println("FlareMQ NameServer startup options:");
        ...
        System.out.println("  java -jar flare-mq-nameserver.jar");
        System.out.println("  java -jar flare-mq-nameserver.jar -p 9876");
        System.out.println("  java -jar flare-mq-nameserver.jar -a 192.168.1.100:9876 -c MyCluster");
    }
