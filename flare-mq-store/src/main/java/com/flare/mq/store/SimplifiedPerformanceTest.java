...
public class SimplifiedPerformanceTest {
    ...
    private static void testBasicStorage() {
        ...
        String testStorePath = System.getProperty("java.io.tmpdir") + File.separator + "flare-mq-simple-test-" + System.currentTimeMillis();
        ...
        try {
            ...
            // 测试单条消息
            Message message = new Message("test-topic", "test-tag", "test-key", "Hello FlareMQ!".getBytes());
    ...
    private static void testPerformance() {
        ...
        String testStorePath = System.getProperty("java.io.tmpdir") + File.separator + "flare-mq-perf-test-" + System.currentTimeMillis();
        DefaultMessageStore messageStore = new DefaultMessageStore(testStorePath);
        ...
        try {
            ...
            byte[] messageBody = "Performance test message content for FlareMQ storage engine.".getBytes();
