...
public class PerformanceBenchmark {
    ...
    public static void main(String[] args) {
        System.out.println("开始FlareMQ存储引擎性能基准测试");
    ...
    private static void testConcurrentPerformance() throws InterruptedException {
        ...
        String testStorePath = System.getProperty("java.io.tmpdir") + File.separator + "flare-mq-concurrent-test-" + System.currentTimeMillis();
        DefaultMessageStore messageStore = new DefaultMessageStore(testStorePath);
