...
public class BrokerStartup {
    ...
    public static void main(String[] args) {
        try {
            logger.info("=== FlareMQ Broker is starting ===");
            ...
            logger.info("=== FlareMQ Broker started successfully ===");
    ...
    private static void printUsage() {
        System.out.println("FlareMQ Broker startup options:");
        ...
        System.out.println("  java -jar flare-mq-broker.jar");
        System.out.println("  java -jar flare-mq-broker.jar -n localhost:9876");
        System.out.println("  java -jar flare-mq-broker.jar -a 192.168.1.100:10911 -c MyCluster");
        System.out.println("  java -jar flare-mq-broker.jar -b broker-1 -i 1 -r slave");
    }
